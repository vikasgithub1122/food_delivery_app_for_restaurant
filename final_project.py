...
def edit_food(filename, food_ID):
    with open(filename) as file:
        ...
        if food_ID in content.keys():
            print("what you want to update in food idems")
            print("1) Food name")
            print("2) Food Quantity")
            print("3) Food price")
            print("4) Discont on food")
            print("5) Stock availablity")
            ...
            if y=="1":
                ...
                content[food_ID]["Discount"]=input("Enter Updated disount value")
            elif y=='5':
...
def update_user_profile(filename):
    ...
    for i in content:
        ...
        if val=='1':
            i["Full_Name"]=input("Enter your updated name:")
        ...
        if val=='4':
            i["Phone number"]=input("Enter new phone numbers:")
        else:
            break
    file.seek(0)
    file.truncate()
